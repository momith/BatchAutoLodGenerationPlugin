...
#include "BatchLODGeneratorEditorMode.generated.h"
 ...
 */
UCLASS()
class UBatchLODGeneratorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_BatchLODGeneratorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UBatchLODGeneratorEditorMode();
	virtual ~UBatchLODGeneratorEditorMode();
