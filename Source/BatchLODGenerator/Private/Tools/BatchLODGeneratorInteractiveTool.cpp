...
#include "BatchLODGeneratorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UBatchLODGeneratorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UBatchLODGeneratorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UBatchLODGeneratorInteractiveTool* NewTool = NewObject<UBatchLODGeneratorInteractiveTool>(SceneState.ToolManager);
...
UBatchLODGeneratorInteractiveToolProperties::UBatchLODGeneratorInteractiveToolProperties()
{
...
void UBatchLODGeneratorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UBatchLODGeneratorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UBatchLODGeneratorInteractiveToolProperties>(this, "Measurement");
...
void UBatchLODGeneratorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UBatchLODGeneratorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UBatchLODGeneratorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UBatchLODGeneratorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UBatchLODGeneratorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UBatchLODGeneratorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UBatchLODGeneratorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UBatchLODGeneratorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UBatchLODGeneratorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
