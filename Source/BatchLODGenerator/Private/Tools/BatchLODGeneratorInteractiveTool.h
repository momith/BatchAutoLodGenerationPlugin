...
#include "BatchLODGeneratorInteractiveTool.generated.h"


/**
 * Builder for UBatchLODGeneratorInteractiveTool
 */
UCLASS()
class BATCHLODGENERATOR_API UBatchLODGeneratorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UBatchLODGeneratorInteractiveTool
 */
UCLASS(Transient)
class BATCHLODGENERATOR_API UBatchLODGeneratorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UBatchLODGeneratorInteractiveToolProperties();
...
/**
 * UBatchLODGeneratorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class BATCHLODGENERATOR_API UBatchLODGeneratorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UBatchLODGeneratorInteractiveToolProperties> Properties;
